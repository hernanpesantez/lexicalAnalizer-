...
public abstract class LexAnalyzer extends IO {
	public enum State {
		...
		Underscore, // 21 identifiers followed by "_"

		// keyword states

		Keyword_def, Keyword_if, Keyword_then, Keyword_else, Keyword_and, Keyword_or, Keyword_not, Keyword_pair,
		Keyword_first, Keyword_second, Keyword_nil,

		UNDEF;

		private boolean isFinal() {
			return (this.compareTo(State.FloatF) <= 0);
		}
	}
	...
	private static State nextState[][] = new State[23][131];
